...
<body>
	...
	<div class="container">
		<form class="form form-horizontal"
			action="/saveCollateral/realestate/" method="POST">
							...
							<div class="col">
								<div class="input-group input-group-lg mb-3">
									...
									<input type="text" name="ownerName" class="form-control"
										placeholder="Enter Owner Name" pattern="^[a-zA-Z]+(\s[a-zA-Z]+)?$" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-4">
						<div class="row">
							<div class="col">
								<div class="input-group input-group-lg mb-3">
									<div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon1">Area(sqft.)</span>
									</div>
									<input type="number" name="areaInFt" class="form-control"
