...
<html lang="en">
    ...
    %>
        <div class="row">
            ...
            <div class="col-8">
                <h1 class="display-1" style="color: white; text-align: center;">Risk Assessment</h1> 
            </div>
            <div class="col-2">
            ...
            <div class="container">
            <form class="form form-horizontal" action="/getRiskOfCollateral/status" method="GET">
                    ...
                    <div class="row" style="margin-top: 15%;">
                        <div class="col">
                                    <div class="input-group input-group-lg mb-3">
                                            ...
                                            <input type="number" name="loanId" class="form-control" placeholder="Enter Loan Id for which risk to be evaluated" required>
                                        </div>
                            </div>
                            </div>
                            <div class="row" style="margin-top:3%;">
                                <div class="col">
                                    <button type="submit" class="btn btn-dark " style="margin-left:25%; width: 50%;">Assess Risk</button> 
                                </div>
                            </div>
                        </div>         
                    </form>
