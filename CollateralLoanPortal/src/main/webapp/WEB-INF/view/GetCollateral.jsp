...
<html lang="en">
    ...
    %>
        <div class="row">
            ...
            <div class="col-8">
                <h1 class="display-1" style="color: white; text-align: center;">Get Collateral Details</h1> 
            </div>
            <div class="col-2">
                    ...
                    <div class="row" style="margin-top: 15%;">
                        <div class="col-6">
                            <div class="row">
                                <div class="col">
                                    <div class="input-group input-group-lg mb-3">
                                            ...
                                            <input type="number" name="loanId" class="form-control" placeholder="Enter Loan Id" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group input-group-lg mb-3">
                                                ...
                                                <input type="number" name="customerId" class="form-control" placeholder="Enter Customer Id" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="margin-top:3%;">
                                <div class="col">
                                    <button type="submit" class="btn btn-dark " style="margin-left:25%; width: 50%;">Get Collateral</button> 
                                </div>
                            </div>
                        </div>         
                    </form>
                ...
                <div class="container-fluid">
                    <div class="row" style="">
                        <div class="col float-left">
                            <div class="fix">
                                <a href="C:\Users\899723\OneDrive - Cognizant\Desktop\MFPE\JSPs\Home.html" style="font-size: larger;">
